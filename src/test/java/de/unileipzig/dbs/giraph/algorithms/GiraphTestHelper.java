package de.unileipzig.dbs.giraph.algorithms;
...
public abstract class GiraphTestHelper {
   ...
   * @return a connected graph where each vertex has its id as value
   */
  public static String[] getConnectedGraphValues() {
    return new String[]{
      "100845892414440741140 1 2 3",
      "1 0 2 3",
      "2 0 1 3 4",
      "3 0 1 2",
      "4 2 5 6 7",
   ...
   */
  public static String[] getLoopGraphWithVertexValues() {
    return new String[]{
      "0 0 1 2",
      "1 1 0 3",
      "2 1 0 3",
   ...
   */
  public static String[] getDisconnectedGraphWithVertexValues() {
    return new String[]{
      "0 0 1 2 3",
      "1 1 0 2 3",
      "2 2 0 1 3",
   ...
   */
  public static String[] getBipartiteGraphWithVertexValues() {
    return new String[]{
      "0 0 4",
      "1 1 5",
      "2 2 6",
   ...
   */
  public static String[] getCompleteBipartiteGraphWithVertexValue() {
    return new String[] {
      "0 0 4 5 6 7",
      "1 1 4 5 6 7",
      "2 2 4 5 6 7",
